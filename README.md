...
1. Clone repository ini:
    ```bash
    git clone [Masukkan Link GitHub ini]
    ```
2. Buka file `Pertemuan 4.ipynb` di JupyterLab atau Jupyter Notebook.
3. Pastikan seluruh file gambar (`.jpg`), video (`.mp4`), dan folder `haarcascades` berada di direktori yang sama dengan file *notebook*.
